...
export class AdminDeviceControllerService {
   ...
   */
  public assignToDeviceGroupByIdAndGroupId(
    deviceId: number,
    groupId: number,
    observe?: 'body',
  ...
  public assignToDeviceGroupByIdAndGroupId(
    ...
    if (deviceId === null || deviceId === undefined) {
      throw new Error(
        'Required parameter deviceId was null or undefined when calling assignToDeviceGroupByIdAndGroupId.'
      );
    }
    if (groupId === null || groupId === undefined) {
      throw new Error(
        'Required parameter groupId was null or undefined when calling assignToDeviceGroupByIdAndGroupId.'
      );
    }
    ...
    let localVarPath = `/api/v1/admin/device/${this.configuration.encodeParam({
      name: 'deviceId',
      value: deviceId,
      in: 'path',
      style: 'simple',
      ...
      dataType: 'number',
      dataFormat: 'int64',
    })}/device-group/${this.configuration.encodeParam({
      name: 'groupId',
      value: groupId,
      in: 'path',
      style: 'simple',
    ...
    return this.httpClient.request<BaseOutputDevice>(
      'put',
  ...
  public delete6(
    ...
    if (requestBody === null || requestBody === undefined) {
      throw new Error(
        'Required parameter requestBody was null or undefined when calling delete6.'
      );
    }
  ...
  public getByIdWithLogs(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getByIdWithLogs.'
      );
    }
  ...
  public getByPaging7(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<BaseOutputListDevice>>;
  public getByPaging7(
    page?: number,
    size?: number,
    sortBy?: string,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<BaseOutputListDevice>>;
  public getByPaging7(
    page?: number,
    size?: number,
    sortBy?: string,
    ...
    let localVarPath = `/api/v1/admin/device`;
    return this.httpClient.request<BaseOutputListDevice>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
