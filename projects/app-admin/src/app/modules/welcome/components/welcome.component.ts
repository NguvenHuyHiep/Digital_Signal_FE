...
import { RoleType } from '@app-api/lib/api/models/roleType';
import { BaseStorage } from '@app-api/lib/modules/local-store/base-storage';
...
export class WelcomeComponent implements OnInit, AfterViewInit {
  ...
  updateLocale(locale: string) {
    ...
    this.lhLanguageService.setLang(this.lang);
  }
