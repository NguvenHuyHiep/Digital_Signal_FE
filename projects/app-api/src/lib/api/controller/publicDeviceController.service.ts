...
export class PublicDeviceControllerService {
  ...
  public register(
    ...
    if (license === null || license === undefined) {
      throw new Error(
        'Required parameter license was null or undefined when calling register.'
      );
    }
    if (device === null || device === undefined) {
      throw new Error(
        'Required parameter device was null or undefined when calling register.'
      );
    }
    ...
    let localVarPath = `/api/v1/public/device/${this.configuration.encodeParam({
      name: 'license',
      value: license,
      in: 'path',
      style: 'simple',
  ...
  public updateStatus1(
    ...
    if (
      deviceUpdateStatusRequest === null ||
