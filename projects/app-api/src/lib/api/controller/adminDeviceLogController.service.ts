...
export class AdminDeviceLogControllerService {
  ...
  public create5(
    ...
    return this.httpClient.request<BaseOutputDeviceLog>(
      'post',
  ...
  public delete8(
    ...
    let localVarPath = `/api/v1/admin/device-log/${this.configuration.encodeParam(
      {
        name: 'id',
        value: id,
        in: 'path',
  ...
  public getByPaging8(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<BaseOutputListDeviceLog>;
  public getByPaging8(
    page?: number,
    size?: number,
    sortBy?: string,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<BaseOutputListDeviceLog>>;
  public getByPaging8(
    page?: number,
    size?: number,
    sortBy?: string,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<BaseOutputListDeviceLog>>;
  public getByPaging8(
    page?: number,
    size?: number,
    sortBy?: string,
    ...
    let localVarPath = `/api/v1/admin/device-log`;
    return this.httpClient.request<BaseOutputListDeviceLog>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
