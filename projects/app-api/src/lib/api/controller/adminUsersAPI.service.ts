...
export class AdminUsersAPIService {
  ...
  public _delete(
    ...
    let localVarPath = `/api/v1/admin/user/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public assignLicenseByLicenseIdAndId(
    userId: number,
    licenseId: number,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<BaseOutputUser>;
  public assignLicenseByLicenseIdAndId(
    userId: number,
    licenseId: number,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<BaseOutputUser>>;
  public assignLicenseByLicenseIdAndId(
    userId: number,
    licenseId: number,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<BaseOutputUser>>;
  public assignLicenseByLicenseIdAndId(
    userId: number,
    licenseId: number,
    observe: any = 'body',
    ...
    if (userId === null || userId === undefined) {
      throw new Error(
        'Required parameter userId was null or undefined when calling assignLicenseByLicenseIdAndId.'
      );
    }
    if (licenseId === null || licenseId === undefined) {
      throw new Error(
        'Required parameter licenseId was null or undefined when calling assignLicenseByLicenseIdAndId.'
      );
    }
    ...
    let localVarPath = `/api/v1/admin/user/${this.configuration.encodeParam({
      ...
      dataType: 'number',
      dataFormat: 'int64',
    })}/license/${this.configuration.encodeParam({
      name: 'licenseId',
      value: licenseId,
      in: 'path',
      style: 'simple',
    ...
    return this.httpClient.request<BaseOutputUser>(
      'put',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  public getAllByPaging(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpResponse<BaseOutputListUser>>;
  public getAllByPaging(
    page?: number,
    size?: number,
    sortBy?: string,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext }
  ): Observable<HttpEvent<BaseOutputListUser>>;
  public getAllByPaging(
    page?: number,
    size?: number,
    sortBy?: string,
    ...
    let localVarPath = `/api/v1/admin/user`;
    return this.httpClient.request<BaseOutputListUser>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  public getByEmail(
    ...
    let localVarPath = `/api/v1/admin/user/email/${this.configuration.encodeParam(
      {
        name: 'email',
        value: email,
        in: 'path',
