...
export class LhLanguageService {
  ...
  private _supportLangs = [
    {label: 'lang.en', value: 'en',  img: '/assets/images/multiplelanguage/icons8-great-britain-48.png'},
    {label: 'lang.vi', value: 'vi',  img: '/assets/images/multiplelanguage/icons8-vietnam-48.png'}
  ];
