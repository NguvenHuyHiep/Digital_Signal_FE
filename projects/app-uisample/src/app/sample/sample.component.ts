        ...
        this.menuList = [
            ...
            },
            {
                ...
                children: [
                    {
                        title: '分析页',
                        link: '/sample/dashboard/analysis'
                    },
                    {
                        title: '监控页',
                        link: '/sample/dashboard/monitor'
                    },
                    {
                        title: '工作台',
                        link: '/sample/dashboard/workplace'
                    },
                ]
            },
            {
                ...
                children: [
                    {
                        title: '基本表单',
                        link: '/sample/form/basic-form'
                    },
                    {
                        title: '分步表单',
                        link: '/sample/form/step-form'
                    },
                    {
                        title: '高级表单',
                        link: '/sample/form/advanced-form'
                    },
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        children: [
                            {
                                title: '搜索列表（文章）',
                                link: '/sample/list/search/articles'
                            },
                            {
                                title: '搜索列表（项目）',
                                link: '/sample/list/search/projects'
                            },
                            {
                                title: '搜索列表（应用）',
                                link: '/sample/list/search/applications'
                            },
                        ]
                    },
                    {
                        title: '查询表格',
                        link: '/sample/list/table-list'
                    },
                    {
                        title: '标准列表',
                        link: '/sample/list/basic-list'
                    },
                    {
                        title: '卡片列表',
                        link: '/sample/list/card-list'
                    },
                ]
            },
            {
                ...
                children: [
                    {
                        title: '基础详情页',
                        link: '/sample/profile/basic'
                    },
                    {
                        title: '高级详情页',
                        link: '/sample/profile/advanced'
                    },
                ]
            },
            {
                ...
                children: [
                    {
                        title: '成功页',
                        link: '/sample/result/success'
                    },
                    {
                        title: '失败页',
                        link: '/sample/result/fail'
                    },
                ]
            },
            {
                ...
                children: [
                    {
                        title: '403',
                        link: '/sample/exception/403'
                    },
                    {
                        title: '404',
                        link: '/sample/exception/404'
                    },
                    {
                        title: '500',
                        link: '/sample/exception/500'
                    },
                ]
            },
            {
                ...
                children: [
                    {
                        title: '个人中心',
                        link: '/sample/account/center'
                    },
                    {
                        title: '个人设置',
                        link: '/sample/account/settings'
                    },
                ]
            },
            {
                title: 'v12 升级指南',
                icon: 'number:12',
                link: '/sample/migration/v12'
            },
            {
                title: 'v11 升级指南',
                icon: 'number:11',
                link: '/sample/migration/v11'
            },
            {
                title: 'v10 升级指南',
                icon: 'number:10',
                link: '/sample/migration/v10'
            },
            {
                title: '更新日志',
                icon: 'tags',
                link: '/sample/changelog'
            },
        ];
